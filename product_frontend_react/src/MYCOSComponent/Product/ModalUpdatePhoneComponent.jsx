...
function ModalUpdatePhoneComponent(props) {
            ...
            >
                <Fade in={props.openChangePhone}>
                    <div className={classes.paper}>
                        ...
                        <h5 style={{margin:'0px 0px 20px 0px'}}>휴대폰 번호 변경신청</h5>
                            <div style={{fontSize:'11px', color:'gray', textAlign:'left', marginBottom:'5px'}}>변경할 휴대폰 번호</div>
                            <input style={{textAlign:'left', border:'0px', borderRadius:'0px', padding:'8px', fontSize:'11px', color:'gray', backgroundColor:'#E7E7E7', width:'170px', marginBottom:'10px'}} type="text" placeholder="휴대폰 번호를 입력해주세요." name="change_phone" onChange={props.onChange} onKeyPress={props.onKeyPress}/>
...
export default ModalUpdatePhoneComponent
