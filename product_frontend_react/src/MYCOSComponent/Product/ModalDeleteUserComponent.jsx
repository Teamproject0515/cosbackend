            ...
            >
                <Fade in={props.openUserDelete}>
                    <div className={classes.paper} style={{width:'640px'}}>
                        <h5 style={{textAlign:'left'}}>회원 탈퇴</h5>
                        ...
                        <h5 style={{textAlign:'left'}}>회원탈퇴 확인사항</h5>
                        <div style={{fontSize:'12px', textAlign:'left'}}>
                        ...
                        <button style={{backgroundColor:'white', width:'200px', height:'40px', borderRadius:'0px', marginBottom:'10px', boxShadow:'none', fontSize:'13px', border:'1px solid lightgray', marginRight:'10px'}} onClick={props.handleClose}>취소</button>
                        <button style={{backgroundColor:'#444', width:'200px', height:'40px', borderRadius:'0px', marginBottom:'10px', boxShadow:'none', fontSize:'13px', color:'white', border:'0px'}} name='recheck_user_delete' onClick={props.handleOpen}>회원 탈퇴</button>
                    </div>
                </Fade>
            </Modal>
                        ...
                        <Fade in={props.openReCheckUserDelete}>
                            <div className={classes.paper}>
                                <h5>정말 회원 탈퇴 하시겠습니까?</h5>
                                    <Button style={{backgroundColor:'white', width:'200px', height:'40px', borderRadius:'0px', marginBottom:'10px', boxShadow:'none', fontSize:'13px', border:'1px solid lightgray', marginRight:'10px'}} onClick={props.handleClose}>취소</Button>
                                    <Button style={{backgroundColor:'#444', width:'200px', height:'40px', borderRadius:'0px', marginBottom:'10px', boxShadow:'none', fontSize:'13px', color:'white'}} onClick={props.deleteUser}>회원 탈퇴</Button><br/>
                            </div>
                            </Fade>
                    </Modal>       
        </div>
